...
//    tf1.setEditable(false);
 ...
 //   tf8.setEditable(false);
    ...
    this.add(lb11);
    lb11.setBounds(456-270, 640-80+111, 101, 47);
    lb11.setFont(font);
    this.add(tf11);
    tf11.setBackground(Color.WHITE);
    tf11.setBounds(660-270, 640-80, 352, 47);
    tf11.setFont(font);
    tf11.setEditable(false);
    tf11.setBorder(null);
    
    this.add(lb12);
    lb12.setBounds(1156-270, 640-80+111, 101, 47);
    lb12.setFont(font);
    this.add(tf12);
    ...
    this.add(lb13);
    lb13.setBounds(456-270, 640-80+111*2, 101, 47);
    lb13.setFont(font);
    this.add(tf13);
